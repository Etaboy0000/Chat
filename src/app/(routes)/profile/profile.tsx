        ...
        <div className="relative px-6 py-8">
          ...
          <div className="mt-8 grid grid-cols-3 gap-4 border-t pt-6">
            <div className="text-center">
              <span className="block text-2xl font-bold text-gray-900">{profile.stats.messages}</span>
              <span className="text-gray-600">Messages</span>
            </div>
            <div className="text-center">
              <span className="block text-2xl font-bold text-gray-900">{profile.stats.groups}</span>
              <span className="text-gray-600">Groupes</span>
            </div>
            <div className="text-center">
              <span className="block text-2xl font-bold text-gray-900">{profile.stats.sharedFiles}</span>
          ...
          <div className="mt-8 border-t pt-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-600">Membre depuis {profile.joinDate}</span>
              </div>
              <div className="flex items-center space-x-2">
                <svg className="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span className="text-gray-600">Dernière activité : il y a {profile.lastActive}</span>
              </div>
            </div>
          </div>
        </div>
